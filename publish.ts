 ...
 * registry by hand adopts its existing installs instead of stranding them. See "Moving a registry"
 * in the comical README.
 *
...
const PREDECESSOR = `${baseUrl}/sfw/index.json`;
