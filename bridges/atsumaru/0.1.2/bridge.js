...
class AtsumaruBridge extends BridgeBase {
  ...
  resolveCover(dto, size) {
    const pick = (o) => o && (size === "small" ? [o.smallImage, o.mediumImage, o.largeImage, o.image] : [o.largeImage, o.mediumImage, o.smallImage, o.image]).find((v) => typeof v === "string" && v.length > 0);
    const flat = pick(dto);
    if (flat)
...
//# debugId=263167FFD3B9547764756E2164756E21
