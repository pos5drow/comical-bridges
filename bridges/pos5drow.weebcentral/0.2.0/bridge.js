...
class WeebCentralBridge extends BridgeBase {
  ...
  parseListing(html3, page) {
    ...
    const hasNext = $2("button[hx-get*='/search/data']").length > 0;
  ...
  async getSearchResults(req) {
    ...
    const html3 = await this.fetchText(this.searchDataUrl({ text: req.text, page, sort, order, official, status }), this.headers());
    return this.parseListing(html3, page);
  }
...
//# debugId=B9214DA36F74084064756E2164756E21
