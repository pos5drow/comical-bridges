...
class AtsumaruBridge extends BridgeBase {
  ...
  resolveCover(dto, size) {
    ...
    if (poster && typeof poster === "object" && !Array.isArray(poster)) {
      const o = poster;
      const order = size === "small" ? [o.smallUrl, o.mediumUrl, o.largeUrl, o.image] : [o.largeUrl, o.mediumUrl, o.smallUrl, o.image];
      const url = order.find((v) => typeof v === "string" && v.length > 0);
      if (url)
        return this.resolveImage(url);
    }
    const flat = size === "small" ? dto.posterSmall ?? dto.posterMedium ?? poster ?? dto.image : poster ?? dto.posterMedium ?? dto.posterSmall ?? dto.image;
...
//# debugId=7AE5442E91FB6D5564756E2164756E21
